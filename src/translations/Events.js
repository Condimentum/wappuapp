export default {
        ...
        {
          "aika": new Date(2019, 3, 18, 18),
          "nimi": "Kääliösitsit - Osakuntasali",
          "kuvaus": 'Lyhenne sanoista KänniÄäliösitsit. Teekkari laulaa mieluummin kuin hyvin, ja näillä sitseillä käyttää myös viisasten juomaa samoin. Näiden sitsien jälkeen harvoin kuulee sanonnan ”oispa kaljaa”. Digitin ja Nucleuksen lisäksi mukana kääliöilee myös Asteriski! <br> <br> <a href="https://digit.fi/ilmo/10" target="_blank">Ilmoittautumiseen</a>',
        ...
        {
          "aika": new Date(2019, 3, 19, 16),
          "nimi": "Sitsilauluworkshop ja Simapong - Q-talo",
        ...
        {
          "aika": new Date(2019, 3, 20, 16),
          "nimi": "Kerhopäivä: Viini ja jyystö, Typerien juomien kerho ja Typerien pelien ilta - Digitin kiltahuone",
          "kuvaus": "<p>Viini- ja jyystöilta - Kiltahuoneen pohjoissiipi alkaen 16.00: Teekkarit ovat hienoa ja arvokasta väkeä, ja nauttivat viinastaan myös punaisena tai valkoisena. Joskus jopa kuohuvana tai roséna. Tämän alkomaholipitoisen herkun taistelutoverina wapputaistossa  auttaa oivasti keltainen ystävänsä jyystö, jota mukavien (nice = mukava) kerholaisten johdolla pääsemme tässä koettelemuksessa maistelemaan.</p> <p>Typerien juomien kerho - Kiltahuoneen eteläsiipi 18.00: Jos viini ei maistu, ja jottei ainainen bissen lipitys tai siiderin sirkutus pääsisi kyllästyttämään, kokeillaan Typerien juomien illassa jotain uutta! Järjestäjätahot järjestävät järjestyspaikalle järjestyksessä erilaisia järjeltään typeriä juomia, joita sitten järjelliset jäsenistön jäsenet pääsevät maistelemaan. Tapahtuma on myös OPM, joten oma typerä juoma kannattaa ottaa mukaan.</p> <p>Typerien pelien ilta - Kiltahuone tai mikroluokka n. klo 19 alken: Typerät tyypit tyyppaavat typeriä pelejä tyypillisen tyrmäävään tahtiin.",
        ...
        {
          "aika": new Date(2019, 3, 21, 11),
          "nimi": "LOTR-maraton - K124B",
          "kuvaus": "Yleensä maratonit ovat fyysisesti raskaita - vaan ei tänään! Pidennetty matka Keski-Maan läpi alkaa tasan kello 11. Matka katkeaa pariksi minuutiksi noin kello 14.28 sekä 18.15.",
          "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=60.455659,+22.285654&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C60.455659,+22.285654"
        },
        {
        ...
        },
        {
          ...
          "nimi": "Toimistokierros - Lähtö Digitin kiltahuoneelta",
        ...
        {
          "aika": new Date(2019, 3, 24, 17),
          "nimi": "Polkuauto Grand Prix (TIO) - Varvintori",
        ...
        {
          "aika": new Date(2019, 3, 27, 18),
          "nimi": "Wappurännibileet - Q-talo",
          "kuvaus": "<p>Raskaiden työpäiväsitsien jälkeen raksanaiset ja -miehet pääsevät rentoutumaan ja poistamaan työ ressiä after workeille Wappurännibileisiin. Betonimyllyjen pyörityksen ja peltikattoasennusten lomassa päästään saunomaan ja rentoutumaan paljussakin. OPM = oma pyyhe mukaan.</p><p>Sisäänpääsy maksaa erittäin opiskelija-/raksanais/-miesystävällisen 3 €. Pukeudu teeman mukaan!</p>",
          "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=Q-talo&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7CQ-talo"
        },
        {
          "aika": new Date(2019, 3, 28, 14),
        ...
        },
        {
          ...
          "nimi": "Wappuaatto ja lakitus - Educariumin takainen kenttä",
          ...
          "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=60.458308,+22.284175&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C60.458308,+22.284175"
        },
        {
  ...
  en: [
    ...
    },
    {
      ...
      "kuvaus": 'Teekkari sings more gladly than well, and can drink booze smartly. Welcome to the booze buffet. Here all the drinks are included in the price. BYOH - Bring Your Own Helmet! <br> <br> <a href="https://digit.fi/ilmo/10" target="_blank">Registration</a>',
      "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=60.454787,+22.287281&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C60.454787,+22.287281"
    },
    {
      "aika": new Date(2019, 3, 19, 16),
      "nimi": "Lyrics contest and Mead Pong - Q-talo (Q-house)",
    ...
    {
      "aika": new Date(2019, 3, 20, 16),
      "nimi": "Club day - Digit Guildroom",
      "kuvaus": " <p>Wine & \"Dine\" club - North wing of guildroom 16:00-->: The teekkaris are classy and well-mannered and they enjoy their alcohol also red and white. Sometimes even sparkly or rosé. The serving of the night goes well with this alcoholic drink. The serving might include - but is not limited to - cheese and short films acted by well-paid actors with good working conditions.</p> <p>The club of stupid drinks - South wing of guildroom 15:00-16:30: If wine's not for your tasting, and you don't want to drink just beer or cider, welcome to the club and try something completely different! The organizers will bring some absurd drinks that you can taste. You are also encouraged to bring your own stupid alcoholic drink with you that everybody can taste.</p> <p>The club of stupid games - Guildroom ~19:00-->: If you prefer board games, this is the club for you.</p>",
      "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=60.455659,+22.285654&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C60.455659,+22.285654"
    },
    {
      "aika": new Date(2019, 3, 21, 11),
      "nimi": "LOTR marathon - K124B, Agora",
      "kuvaus": "Usually marathons are physically exhausting, but not this one. In de deeps of Agora we'll watch through the classic trilogy of Lord of the Rings.",
      "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=60.455659,+22.285654&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C60.455659,+22.285654"
    },
    {
      "aika": new Date(2019, 3, 22, 14),
    ...
    {
      "aika": new Date(2019, 3, 27, 18),
      "nimi": "Launder party - Q-talo (Q-house)",
      "kuvaus": "After the heavy sitz you get to relax and relief the stress with the afterwork launder party. Bring your own towel in case you’re eager to sauna or bath. The entrance fee for this party is as cheap as 3 €. Dressing up by theme (construction site) is appreciated!",
      "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=Q-talo&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7CQ-talo"
    },
    {
      "aika": new Date(2019, 3, 28, 14),
    ...
    {
      "aika": new Date(2019, 3, 30, 14),
      "nimi": "Wappu eve and Teekkari hat ceremony - Field behind Educarium",
    ...
    {
      "aika": new Date(2019, 3, 30, 19),
      "nimi": "Equipping the statue of Paavo Nurmi with a Teekkari hat",
      "kuvaus": "Everybody interested of tech education or holidays is invited to celebrate wappu at the statue of Paavo Nurmi. Noble speeches and acts are presented when Paavo gets equipped a Teekkari hat.",
      "kartta": "https://maps.googleapis.com/maps/api/staticmap?center=60.448009,+22.270176&zoom=17&scale=false&size=600x600&maptype=roadmap&key=AIzaSyCWrM7xzlmZHgQro8cGpxJp-VM__2oNpME&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C60.448009,+22.270176"
    },
    {
      "aika": new Date(2019, 4, 1, 0),
