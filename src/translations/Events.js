export default {
        ...
        {
          "aika": new Date(2019, 3, 20, 15),
          "nimi": "Kerhopäivä: Viini ja jyystö, Typerien juomien kerho ja Typerien pelien ilta - Digitin kiltahuone",
          "kuvaus": "<p>Typerien juomien kerho - Kiltahuoneen pohjoissiipi 15.00-16.30: Jos viini ei maistu, ja jottei ainainen bissen lipitys tai siiderin sirkutus pääsisi kyllästyttämään, kokeillaan Typerien juomien illassa jotain uutta! Järjestäjätahot järjestävät järjestyspaikalle järjestyksessä erilaisia järjeltään typeriä juomia, joita sitten järjelliset jäsenistön jäsenet pääsevät maistelemaan. Tapahtuma on myös OPM, joten oma typerä juoma kannattaa ottaa mukaan.</p> <p>Viini- ja jyystöilta - Kiltahuoneen pohjoissiipi alkaen 16.30: Teekkarit ovat hienoa ja arvokasta väkeä, ja nauttivat viinastaan myös punaisena tai valkoisena. Joskus jopa kuohuvana tai roséna. Tämän alkomaholipitoisen herkun taistelutoverina wapputaistossa  auttaa oivasti keltainen ystävänsä jyystö, jota mukavien (nice = mukava) kerholaisten johdolla pääsemme tässä koettelemuksessa maistelemaan.</p> <p>Typerien pelien ilta - Kiltahuoneen eteläsiipi koko tapahtuman ajan: Typerät tyypit tyyppaavat typeriä pelejä tyypillisen tyrmäävään tahtiin.",
